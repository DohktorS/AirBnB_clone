...
class TestReviewDocs(unittest.TestCase):
    ...
    def test_review_module_docstring(self):
        ...
        self.assertIsNot(review._doc_, None,

                         "review.py needs a docstring")

        self.assertTrue(len(review._doc_) >= 1,
...
class TestReview(unittest.TestCase):
    ...
    def test_to_dict_creates_dict(self):
        ...
        for attr in r._dict_:

            self.assertTrue(attr in new_d)

            self.assertTrue("_class_" in new_d)
    ...
    def test_to_dict_values(self):
        ...
        self.assertEqual(new_d["_class_"], "Review")
    ...
    def test_str(self):
        ...
        string = "[Review] ({}) {}".format(review.id, review._dict_)
